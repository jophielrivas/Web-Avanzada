...
public class MailApiController {
        ...
        try (Scanner scanner = new Scanner(response)) {
            ...
            if (!aux.equalsIgnoreCase("[]")) {
                ...
                for (String string : myList) {
                    ...
                    enviarCorreo(string.substring(1, string.length() - 1), "Un cliente ha adquirido nuestros servicios",
                            mail);
                }
            }
        }
    ...
    public boolean enviarCorreo(String destinatario,String subject,String html){
        try {
            ...
            .withSMTPServer("smtp.sendgrid.net", 587, "apikey", "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")
        ...
        Email email = EmailBuilder.startingBlank()
                .from("info@nojar.do")
                .to(destinatario)
                .withReplyTo("Soporte", "info@nojar.do")
                .withSubject(subject)
                .withHTMLText(html)
                .withPlainText("No visualiza la información en formato html")

                .withReturnReceiptTo()
                .withBounceTo("info@nojar.do")
                .buildEmail();
